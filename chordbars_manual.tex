...
This is done by issuing the command {\btt \tbs printNbBars} at the end of the file, and it is printed in minutes/seconds%
\footnote{Thanks to \url{https://github.com/jsangradorp}}.
...
{\btt \tbs bpm\{120\}} (the default value is 100).
